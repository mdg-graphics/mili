 ...
 * of the file.
 */
Bool_type is_mili_db(char *fname)
{
 ...
 */
Bool_type is_taurus_plot_db(char *fname)
{
    FILE *p_f;
    Bool_type rval;
    int ctl[CTL_WORDS];
    ...
    if ( p_f != NULL )
    {
        ...
        else if ( ctl[19] != 0 && ctl[19] != 1 )
        { /* node temperature flag */
            rval = FALSE;
        }
        else if ( ctl[20] != 0 && ctl[20] != 1 )
        { /* node displacements flag */
            rval = FALSE;
        }
        else if ( ctl[21] != 0 && ctl[21] != 1 )
        { /* node velocities flag */
            rval = FALSE;
        }
        else if ( ctl[22] != 0 && ctl[22] != 1 )
        { /* node accelerations flag */
            rval = FALSE;
        }
 ...
 */
Bool_type is_byte_swapped_taurus_plot_db(char *fname)
{
    FILE *p_f;
    Bool_type rval;
    ...
    if ( p_f != NULL )
    {
        ...
        else if ( ctl[19] != 0 && ctl[19] != 16777216 )
        { /* node temperature flag */
            rval = FALSE;
        }
        else if ( ctl[20] != 0 && ctl[20] != 16777216 )
        { /* node displacements flag */
            rval = FALSE;
        }
        else if ( ctl[21] != 0 && ctl[21] != 16777216 )
        { /* node velocities flag */
            rval = FALSE;
        }
        else if ( ctl[22] != 0 && ctl[22] != 16777216 )
        { /* node accelerations flag */
            rval = FALSE;
        }
