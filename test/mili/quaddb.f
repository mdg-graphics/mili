c $Id: quaddb.f,v 1.1 2021/07/23 16:03:03 rhathaw Exp $
...
c.....MUST open the family
      ...
      call mf_open( 'quado', 'data', 'AwPs', fid, stat )
      if ( stat .ne. 0 ) then
...
c.....Write a title
      call mf_wrt_string( fid, 'title', "2D Quad test db", 
     +                    stat )
...
c....+                    obj_blocks, stat )
      call mf_def_subrec( fid, srec_id, quads_l, m_object_ordered, 2, 
...
c.....Write five records, each with one call.
      ...
      call mf_wrt_stream( fid, m_real, 77, state_record1, stat )
      ...
      call mf_wrt_stream( fid, m_real, 77, state_record2, stat )
      call mf_print_error( 'mf_wrt_stream', stat )
      ...
      call mf_wrt_stream( fid, m_real, 77, state_record3, stat )
      call mf_print_error( 'mf_wrt_stream', stat )
      ...
      call mf_wrt_stream( fid, m_real, 77, state_record4, stat )
      call mf_print_error( 'mf_wrt_stream', stat )
      ...
      call mf_wrt_stream( fid, m_real, 77, state_record5, stat )
      call mf_print_error( 'mf_wrt_stream', stat )
