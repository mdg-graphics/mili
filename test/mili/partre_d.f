c $Id: partre_d.f,v 1.1 2021/07/23 16:03:03 rhathaw Exp $
...
c product endorsement purposes.
      ...
      program partre_d
c.....Creates a database with no states ("premptA") which is intended as an
c.....input to partre_e to exercise Mili restart capability.
...
c.....MUST open the family
      ...
      call mf_open( 'prempt', 'data', 'AwPs', fid, stat )
      if ( stat .ne. 0 ) then
...
c.....Format complete, close state record
...
c  
c     call mf_flush( fid, m_non_state_data, stat )
c     call mf_print_error( 'mf_commit', stat )
