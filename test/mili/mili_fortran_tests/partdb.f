c $Id: partdb.f,v 1.1 2021/07/23 16:03:03 rhathaw Exp $
...
c.....MUST open the family
      ...
      call mf_open( 'partdb.plt', '.', 'AwPs', fid, stat )
      if ( stat .ne. 0 ) then
...
c.....Define a hex class
      ...
      call mf_def_conn_seq_labels( fid, mesh_id, hexs_s, 1, 1, 
     +                             hex_labels, hex_1_1, stat )
