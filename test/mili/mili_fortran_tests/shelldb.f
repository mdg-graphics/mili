c $Id: shelldb.f,v 1.1 2021/07/23 16:03:03 rhathaw Exp $
...
c.....Quad state variables
     ...
     +    stress_comp_short /
     +        'stress_in-sx', 'stress_in-sy', 'stress_in-sz',
     +        'stress_in-sxy', 'stress_in-syz', 'stress_in-szx',
     +        'stress_mid-sx', 'stress_mid-sy', 'stress_mid-sz',
     +        'stress_mid-sxy', 'stress_mid-syz', 'stress_mid-szx',
     +        'stress_out-sx', 'stress_out-sy', 'stress_out-sz',
     +        'stress_out-sxy', 'stress_out-syz', 'stress_out-szx' /,
     +    stress_comp_long /
     ...
     +        'Nxx', 'Nyy', 'Nxy' /,
     +    strain_comp_short /
     +        'strain_in-sx', 'strain_in-sy', 'strain_in-sz',
     +        'strain_in-sxy', 'strain_in-syz', 'strain_in-szx',
     +        'strain_out-sx', 'strain_out-sy', 'strain_out-sz',
     +        'strain_out-sxy', 'strain_out-syz', 'strain_out-szx' /,
     +    strain_comp_long /
...
c.....MUST open the family
      ...
      call mf_open( 'shelldb.plt', '.', 'AwPs', fid, stat )
      if ( stat .ne. 0 ) then
...
c.....MUST define state variables prior to binding subrecord definitions
     ...
     +                      quad_long(3), stress_comp_short(7), 
     +                      stress_comp_long(1), stat )
      call mf_print_error( 'mf_def_vec_svar', stat )
      
      call mf_def_vec_svar( fid, m_real, 6, quad_short(5), 
     +                      quad_long(5), stress_comp_short(13), 
     +                      stress_comp_long(1), stat )
      call mf_print_error( 'mf_def_vec_svar', stat )
     ...
     +                      quad_long(13), strain_comp_short(7), 
     +                      strain_comp_long(1), stat )
      call mf_print_error( 'mf_def_vec_svar', stat )
