c $Id: tridb.f,v 1.1 2021/07/23 16:03:03 rhathaw Exp $
...
c.....Nodes 1:9
     ...
     +    1.5, 0.5,  1.0, 1.0,  2.0, 1.0,  1.5, 1.5, 2.0, 2.0 /
      integer n_labels(9)
      data n_labels / 1, 2, 3, 4, 5, 6, 7, 8, 9 /
...
c.....Tri 1:8 connectivities; 3 nodes, 1 material, 1 part
     ...
     +    6, 7, 8, 1, 1,
     +    8, 7, 9, 1, 1 /
      integer tri_labels(8)
      data tri_labels / 1, 2, 3, 4, 5, 6, 7, 8 /
...
c.....MUST open the family
      ...
      call mf_open( 'tridb.plt', '.', 'AwPs', fid, stat )
      if ( stat .ne. 0 ) then
...
c.....Define a node class.
      ...
      call mf_def_node_labels(fid, mesh_id, nodal_s, 9, n_labels, stat)
...
c.....Define a tri class
      ...
      call mf_def_conn_seq_labels( fid, mesh_id, tris_s, 1, 8, 
     +                             tri_labels, tri_1_8, stat )
