c $Id: hexdb.f,v 1.1 2021/07/23 16:03:03 rhathaw Exp $
...
c.....MUST open the family
      ...
      call mf_open( 'hexdb.plt', '.', 'AwPd', fid, stat )
      if ( stat .ne. 0 ) then
...
c.....Write a title
      call mf_wrt_string( fid, 'title', "Hex db test 1", 
     +                    stat )
