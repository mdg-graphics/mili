c $Id: partre_b.f,v 1.1 2021/07/23 16:03:03 rhathaw Exp $
...
c product endorsement purposes.
      ...
      program partre_b
c.....Intended to start with output of partre and exercise Mili restart
c.....features by truncating the "prest..." database.
...
c.....Truncate by restart on file index
      call mf_restart_at_file( fid, 2, stat )
      call mf_print_error( 'mf_restart_at_file', stat )

c.....Truncate by restart on state index
c     call mf_restart_at_state( fid, 3, 0, stat )
