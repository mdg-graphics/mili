c $Id: hexdb.f,v 1.13 2006/04/24 21:02:20 pierce5 Exp $
...
c.....MUST open the family
      ...
      call mf_open( 'hexo', 'data', 'AwPs', fid, stat )
      if ( stat .ne. 0 ) then
...
c.....Define a hex class
      ...
      call mf_def_conn_seq( fid, mesh_id, hexs_s, 3, 3, 
     +                      hex_1_3, stat )
...
c.....Write five records, each with one call.
      ...
      call mf_wrt_stream( fid, m_real, 151, state_record1, stat )
      ...
      call mf_wrt_stream( fid, m_real, 151, state_record2, stat )
      call mf_print_error( 'mf_wrt_stream', stat )
      ...
      call mf_wrt_stream( fid, m_real, 151, state_record3, stat )
      call mf_print_error( 'mf_wrt_stream', stat )
      ...
      call mf_wrt_stream( fid, m_real, 151, state_record4, stat )
      call mf_print_error( 'mf_wrt_stream', stat )
      ...
      call mf_wrt_stream( fid, m_real, 151, state_record5, stat )
      call mf_print_error( 'mf_wrt_stream', stat )
