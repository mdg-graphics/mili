...
mapping = {
    "xmilics/d3samp6": {
        "keep_on_fail_file_expr": ["plt", "answ", "jansw"],
        "keep_on_pass_file_expr": ["plt"],
        "test_type": "mililib",
        "quicklist": ["d3samp6_default_combine", "d3samp6_limit_states",
                      "d3samp6_limit_procs"],
        "file_suffix": None,
        "output_suffix": "jansw",
        "awkfiles": [],
        ...
        "tests": {
            "d3samp6_default_combine": {
                "required_files_alt_dir":"xmilics/d3samp6",
                "required_files": [
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i d3samp6.plt -o d3samp6_combined.plt")],
            ...
            "d3samp6_limit_states": {
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i d3samp6.plt -o d3samp6_limit_states.plt -start 20 -stop 40")],
            ...
            "d3samp6_limit_procs": {
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i d3samp6.plt -o d3samp6_limit_procs.plt -proc 4-8")],
            ...
            "d3samp6_pstart_pstop": {
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i d3samp6.plt -o d3samp6_limit_procs.plt -pstart 4 -pstop 8")],
                "xmilics_args": "-i d3samp6.plt -o d3samp6_limit_procs.plt -pstart 4 -pstop 8"
            }
        } 
    },
    "xmilics/bar1": {
        ...
        "keep_on_pass_file_expr": ["plt"],
        "test_type": "mililib",
        "quicklist": ["bar1_default_combine", "bar1_limit_states",
                      "bar1_limit_procs"],
        "file_suffix": None,
        "output_suffix": "jansw",
        "awkfiles": [],
        ...
        "tests": {
            "bar1_default_combine": {
                "required_files_alt_dir":"xmilics/bar1",
                "required_files": [
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i bar1.plt -o bar1_combined.plt")],
            ...
            "bar1_limit_states": {
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i bar1.plt -o bar1_limit_states.plt -start 20 -stop 40")],
            ...
            "bar1_limit_procs": {
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i bar1.plt -o bar1_limit_procs.plt -proc 1,2,3")],
            ...
            "bar1_pstart_pstop": {
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i bar1.plt -o bar1_limit_procs.plt -pstart 1 -pstop 4")],
    ...
    "xmilics/shell_mat2": {
        ...
        "keep_on_pass_file_expr": ["plt"],
        "test_type": "mililib",
        "quicklist": ["shell_mat2_default_combine", "shell_mat2_limit_states",
        ...
        "tests": {
            "shell_mat2_default_combine": {
                "required_files_alt_dir":"xmilics/shell_mat2",
                "required_files": [
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i shell_mat2.plt -o shell_mat2_combined.plt")],
            ...
            "shell_mat2_limit_states": {
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i shell_mat2.plt -o shell_mat2_combined.plt -start 4 -stop 8")],
            ...
            "shell_mat2_limit_procs": {
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i shell_mat2.plt -o shell_mat2_combined.plt -procs 5-10")],
            ...
            "shell_mat2_pstart_pstop": {
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i shell_mat2.plt -o shell_mat2_combined.plt -pstart 5 -pstop 10")],
    ...
    "xmilics/bar5": {
        ...
        "keep_on_pass_file_expr": ["plt"],
        "test_type": "mililib",
        "quicklist": ["bar5_default_combine", "bar5_limit_states",
                      "bar5_limit_procs"],
        "file_suffix": None,
        "output_suffix": "jansw",
        "awkfiles": [],
        ...
        "tests": {
            "bar5_default_combine": {
                "required_files_alt_dir":"xmilics/bar5",
                "required_files": [
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i bar5.plt -o bar5_combined.plt")],
            ...
            "bar5_limit_states": {
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i bar5.plt -o bar5_limit_states.plt -start 20 -stop 60")],
            ...
            "bar5_limit_procs": {
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i bar5.plt -o bar5_limit_procs.plt -proc 13-23")],
            ...
            "bar5_pstart_pstop": {
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i bar5.plt -o bar5_limit_procs.plt -pstart 13 -pstop 23")],
    ...
    "xmilics/ml40": {
        ...
        "keep_on_pass_file_expr": ["plt"],
        "test_type": "mililib",
        "quicklist": ["ml40_default_combine", "ml40_limit_states",
                      "ml40_limit_procs"],
        "file_suffix": None,
        "output_suffix": "jansw",
        "awkfiles": [],
        ...
        "tests": {
            "ml40_default_combine": {
                "required_files_alt_dir":"xmilics/ml40",
                "required_files": [
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i ml40.plt -o ml40_combined.plt")],
            ...
            "ml40_limit_states": {
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i ml40.plt -o ml40_limit_states.plt -start 20 -stop 40")],
            ...
            "ml40_limit_procs": {
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i ml40.plt -o ml40_limit_procs.plt -proc 1,2,3")],
    ...
    "xmilics/basic2": {
        ...
        "keep_on_pass_file_expr": ["plt"],
        "test_type": "mililib",
        "quicklist": ["basic2_default_combine", "basic2_limit_states",
                      "basic2_limit_procs"],
        "file_suffix": None,
        "output_suffix": "jansw",
        "awkfiles": [],
        ...
        "tests": {
            "basic2_default_combine": {
                "required_files_alt_dir":"xmilics/basic2",
                "required_files": [
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i basic2.plt -o basic2_combined.plt")],
            ...
            "basic2_limit_states": {
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i basic2.plt -o basic2_limit_states.plt -start 20 -stop 40")],
            ...
            "basic2_limit_procs": {
                ...
                "file_suffx": None,
                "exec_command": [Template("$CODE -i basic2.plt -o basic2_limit_procs.plt -proc 1,2,3")],
