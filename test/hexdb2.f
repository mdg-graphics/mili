c $Id: hexdb2.f,v 1.13 2006/09/25 19:20:48 empierce Exp $
...
c.....Hex 1:3 connectivities; 8 nodes, 1 material, 1 part
      integer hex_1_3(10,3), hex_list(3)
      data hex_1_3 /
...
c.....MUST open the family
      ...
      call mf_open( 'hex2o', 'data', 'AwPs', fid, stat )
      if ( stat .ne. 0 ) then
...
c.....Define a hex class
      ...
      call mf_def_conn_arb( fid, mesh_id, hexs_s, 3,
     +                      hex_list, hex_1_3, stat )
