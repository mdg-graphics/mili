...
mapping = {"derived":{"keep_on_fail_file_expr":None,
		   ...
		   "image/bolt":{"keep_on_fail_file_expr":[".gsf",".plt",".jpg", "jpeg"],
						  ...
						  "quicklist":[
                                                               ...
                                                               "bolt_image_szx_cutpln1_plot" , "bolt_image_szx_cutpln1_plot"
                                                              ],
						  "test_type":"image",
						  "file_suffix":".gsf",
						  "base_suffix":"jpg",
 		   ...
 		   "image/clamped_plate":{"keep_on_fail_file_expr":[".gsf",".plt",".jpg", ".jpeg"],
						  ...
						  "awk_commands":[],
						  "required_files_alt_dir":"image",
						  "required_files":["clamped_plate.th00",  "clamped_plate.thA",  "clamped_plate.th_TI_A", "clamped_plate_image_et1_plot.gsf"],
 		   ...
 		   "image/d3snd1":{"keep_on_fail_file_expr":[".gsf",".plt",".jpg",".jpeg"],
						  "keep_on_pass_file_expr":[".jpg",".gsf",".plt"],
						  "quicklist":[
                                                               "d3snd1_image_sand_plot", "d3snd1_image_sand_th",
							       "d3snd1_image_eeff_plot", "d3snd1_image_eeff_th",
							       "d3snd1_image_eps_plot", "d3snd1_image_eps_th"
                                                              ],
						  "test_type":"image",
						  "file_suffix":".gsf",
						  "base_suffix":"jpg",
