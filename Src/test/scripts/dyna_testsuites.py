...
mapping = {"BAR":{"keep_on_fail_file_expr":[".elem", "hsp", "plt",".dyn"],
                  ...
                  "quicklist":["bar1", "bar1_2", "bar1_4", "bar1_5", "bar1_6", "bar1_7", "bar1_9",
                               "bar1_12","bar2", "bar3",  "bar4",  "bar5",  "bar6",  "bar7",  "bar8",
                               "bar9",  "bar10", "bar10_leos", "bar10_eos5", 
                               ...
                               "bar45", "bar46", "bar49", "bar53", "bar52", "bar54", "bar55", "bar56",
                               "bar59", "bar60", "bar62", "bar63", "bar64", "bar65", "bar66", "bar69",
                               "bar70", "bar71", "bar72", "bar73"],
                  "file_suffix":".dyn",
           ...
           "EOS":{"keep_on_fail_file_expr":[".elem", "hsp", "plt",".dyn"],
                  "keep_on_pass_file_expr":["answ",".dyn"],
                  "quicklist":["brickm9eos3", "brickm9eos9", "brickm9eos11"],
                  "file_suffix":".dyn",
                  "baseline_suffix":"answ",
                  "test_output_suffix":"jansw",
                  "tests":None,
           ...
           "COUNT":{"keep_on_fail_file_expr":[".elem", "hsp", "plt",".dyn"],
	            ...
	            "quicklist":["al_sph_rod",  "airbag1",     "ang_vel",
				 ...
				 "fdamp6",      "gravity_init","isave1",      "moving_wall",
                                 ...
                                 "rigid_body2", "rigid_body3", "rot_init1",   "rot_init2",
                                 "sbi",         "sbp",         "shear_trac1", "shear_trac2", "shear_trac3",
                                 "shm15",       "spc",         "spf",         "sph_box",
           ...
           "PLATE":{"keep_on_fail_file_expr":[".elem", "hsp", "plt",".dyn"],
                    "keep_on_pass_file_expr":["answ",".dyn"], 
	            "quicklist":["plate_4blt", "plate_4yase", "plate_bd",  "plate_blt",
                                 "plate_mem",  "plate_hl",    "plate_yase","plate1",
                                 "plate2",     "plate2i",     "plate3",    "plate4",
           ...
           "SAND":{"keep_on_fail_file_expr":[".elem", "hsp", "plt",".dyn"],
                   "keep_on_pass_file_expr":["answ",".dyn"], 
	           "quicklist":["d3snd1", "d3snd1d", "d3snd1_mfric",
           ...
           "SLIDE":{"keep_on_fail_file_expr":[".elem", "hsp", "plt",".dyn"],
                    "keep_on_pass_file_expr":["answ",".dyn"], 
	            "quicklist":["sslide1k",     "sslide1k_life", "sslide2kc",     "sslide2kt",
                                 ...
                                 "sslide9ptn",   "sslide9ps_frl", "sslide9ps_damp",
           ...
           "SHELL":{"keep_on_fail_file_expr":[".elem", "hsp", "plt",".dyn"],
                    "keep_on_pass_file_expr":["answ",".dyn"], 
	            "quicklist":["BD_2g", "BD_2u", "BD_5t", "BLTr_2g", "BLTr_2u", "BLTr_5t", 
                                 "BLT_2gc", "BLT_2gs", "BLT_2gv", "BLT_2uv", "BLT_3gv", "BLT_4gv", 
                                 "BLT_5gv", "BLT_5tv", "BLT_6tv", "HL_2gc",  "HL_2gs",  "HL_2gvm", 
                                 "HL_2gvp", "HL_2gv",  "HL_2uv",  "HL_5tv",  "MEM_s",   "MEM_v",
                                 "BCIZ_2g", "BCIZ_5t", "BCIZ_2u", "C0_2g",   "C0_5t",   "C0_2u",
                                 "Y4_2g",   "Y4_2u",   "Y4_5t",   "Y_2g",    "Y_2u",    "Y_5t",
           ...
           "MASS_AUG":{"keep_on_fail_file_expr":[".elem", "hsp", "plt",".dyn"],
                       ...
                       "quicklist":["ma_beam_hl",    "ma_beam_bs",     "ma_beam_tr",
                                    "ma_plate_4blt", "ma_plate_4yase", "ma_plate_bd",
           ...
           "TPLATE":{"keep_on_fail_file_expr":[".elem", "hsp", "plt",".dyn"],
                     "keep_on_pass_file_expr":["answ",".dyn"], 
                     "quicklist":["tbasic1", "tplate1", "tshell_m52_frac"],
                     "file_suffix":".dyn",
                     "tests":None,
                     "run_validation_suffix":".hsp",
                     "default_tolerances":{"type":"rel","tolerance":"1.0e-03"},
