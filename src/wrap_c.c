...
#define ASSIGN_STRING_IN(d, sc, sw) \
    {                               \
        (d) = (sc);                 \
    }
...
Return_value mc_set_state_map_file_on_(Famid *fam_id, int *flag)
{
    return mc_set_state_map_file_on(*fam_id, *flag);
}

Return_value mc_set_subrec_check_(Famid *fam_id, int *flag)
{
    return mc_set_subrec_check(*fam_id, *flag);
}

Return_value mc_check_subrec_start_(Famid *fam_id, int *srec_id)
{
    return mc_check_subrec_start(*fam_id, *srec_id);
}
Return_value mc_end_state_(Famid *fam_id, int *srec_id)
{
    return mc_end_state(*fam_id, *srec_id);
}

Return_value mc_activate_visit_file_(Famid *fam_id, int *on_off_switch)
{
    return mc_activate_visit_file(*fam_id, *on_off_switch);
}

Return_value mc_open_(CHAR_DESCR param_root, CHAR_DESCR param_path, CHAR_DESCR param_mode, Famid *fam_id)
{
...
Return_value mc_update_global_times_(Famid *fam_id)
{
    return mc_update_global_times(*fam_id);
}

Return_value mc_write_global_metadata_(Famid *fam_id)
{
    return mc_write_global_metadata(*fam_id);
}

Return_value mc_close_(Famid *fam_id)
{
    return mc_close(*fam_id);
}

Return_value mc_update_visit_file_(Famid *fam_id)
{
    return mc_update_visit_file(*fam_id);
}

void mc_filelock_enable_(void)
{
    mc_filelock_enable();
    return;
}

void mc_filelock_disable_(void)
{
    mc_filelock_disable();
    return;
}

Return_value mc_delete_family_(CHAR_DESCR param_root, CHAR_DESCR param_path)
{
...
Return_value mc_partition_state_data_(Famid *fam_id)
{
    return mc_partition_state_data(*fam_id);
}

Return_value mc_wrt_scalar_(Famid *fam_id, int *type, CHAR_DESCR name, void *p_value)
{
    char *c_name;
...
Return_value mc_set_global_class_count_(Famid *fam_id, CHAR_DESCR name, int *p_value)
{
    char *c_name;
...
Return_value mc_read_scalar_(Famid *fam_id, CHAR_DESCR name, void *p_value)
{
    char *c_name;
...
Return_value mc_get_global_class_count_(Famid *fam_id, CHAR_DESCR name, void *p_value)
{
    char *c_name;
...
Return_value mc_wrt_array_(Famid *fam_id, int *type, CHAR_DESCR name, int *rank, int *dimensions, void *data)
{
    char *c_name;
...
Return_value mc_wrt_string_(Famid *fam_id, CHAR_DESCR name, CHAR_DESCR value)
{
    char *c_name, *c_value;
...
Return_value mc_read_string_(Famid *fam_id, CHAR_DESCR name, CHAR_DESCR value)
{
    char *c_name;
...
Return_value mc_make_umesh_(Famid *fam_id, CHAR_DESCR mesh_name, int *p_dim, int *p_mesh_id)
{
    char *c_mesh_name;
...
Return_value mc_def_class_(Famid *fam_id, int *mesh_id, int *superclass, CHAR_DESCR short_name, CHAR_DESCR long_name)
{
    ...
    return mc_def_class(*fam_id, *mesh_id, *superclass, c_short_name, c_long_name);
}

Return_value mc_def_class_idents_(Famid *fam_id, int *mesh_id, CHAR_DESCR class_name, int *start, int *stop)
{
    char *c_class_name;

    c_class_name = CHAR_CONV_F2C(class_name);

    return mc_def_class_idents(*fam_id, *mesh_id, c_class_name, *start, *stop);
}

Return_value mc_def_nodes_(Famid *fam_id, int *mesh_id, CHAR_DESCR class_name, int *start_node, int *stop_node,
                           float *coords)
{
    char *c_class_name;
    ...
    return mc_def_nodes(*fam_id, *mesh_id, c_class_name, *start_node, *stop_node, coords);
}

Return_value mc_def_node_labels_(Famid *fam_id, int *mesh_id, CHAR_DESCR class_name, int *qty, int *labels)
{
    char *c_class_name;

    c_class_name = CHAR_CONV_F2C(class_name);

    return mc_def_node_labels(*fam_id, *mesh_id, c_class_name, *qty, labels);
}

Return_value mc_def_conn_arb_(Famid *fam_id, int *mesh_id, CHAR_DESCR class_name, int *qty, int *elem_ids, int *data)
{
    char *c_class_name;

    c_class_name = CHAR_CONV_F2C(class_name);

    return mc_def_conn_arb(*fam_id, *mesh_id, c_class_name, *qty, elem_ids, data);
}

Return_value mc_def_conn_arb_labels_(Famid *fam_id, int *mesh_id, CHAR_DESCR class_name, int *qty, int *elem_ids,
                                     int *labels, int *data)
{
    char *c_class_name;
    ...
    return mc_def_conn_arb_labels(*fam_id, *mesh_id, c_class_name, *qty, elem_ids, labels, data);
}

Return_value mc_def_conn_arb_labels_global_ids_(Famid *fam_id, int *mesh_id, CHAR_DESCR class_name, int *qty,
                                                int *elem_ids, int *labels, int *data, int *global_ids)
{
    char *c_class_name;

    c_class_name = CHAR_CONV_F2C(class_name);

    return mc_def_conn_arb_labels_global_ids(*fam_id, *mesh_id, c_class_name, *qty, elem_ids, labels, data, global_ids);
}

Return_value mc_def_conn_seq_labels_(Famid *fam_id, int *mesh_id, CHAR_DESCR class_name, int *start_el, int *stop_el,
                                     int *labels, int *data)
{
    char *c_class_name;
    ...
    return mc_def_conn_seq_labels(*fam_id, *mesh_id, c_class_name, *start_el, *stop_el, labels, data);
}

Return_value mc_def_seq_labels_(Famid *fam_id, int *mesh_id, CHAR_DESCR class_name, int *start_el, int *stop_el,
                                int *labels)
{
    char *c_class_name;
    ...
    return mc_def_seq_labels(*fam_id, *mesh_id, c_class_name, *start_el, *stop_el, labels);
}

Return_value mc_def_conn_seq_labels_global_ids_(Famid *fam_id, int *mesh_id, CHAR_DESCR class_name, int *start_el,
                                                int *stop_el, int *labels, int *data, int *global_ids)
{
    char *c_class_name;

    c_class_name = CHAR_CONV_F2C(class_name);

    return mc_def_conn_seq_labels_global_ids(*fam_id, *mesh_id, c_class_name, *start_el, *stop_el, labels, data,
                                             global_ids);
}

Return_value mc_def_conn_seq_(Famid *fam_id, int *mesh_id, CHAR_DESCR class_name, int *start_el, int *stop_el,
                              int *data)
{
    char *c_class_name;
    ...
    return mc_def_conn_seq(*fam_id, *mesh_id, c_class_name, *start_el, *stop_el, data);
}

Return_value mc_def_conn_labels_(Famid *fam_id, int *mesh_id, CHAR_DESCR class_name, int *qty, int *idents, int *labels)
{
    char *c_class_name;

    c_class_name = CHAR_CONV_F2C(class_name);

    return mc_def_conn_labels(*fam_id, *mesh_id, c_class_name, *qty, idents, labels);
}

Return_value mc_def_global_ids_(Famid *fam_id, int *mesh_id, CHAR_DESCR class_name, int *qty, int *idents,
                                int *global_ids)
{
    char *c_class_name;
    ...
    return mc_def_global_ids(*fam_id, *mesh_id, c_class_name, *qty, idents, global_ids);
}

Return_value mc_load_conn_labels_(Famid *fam_id, int *mesh_id, CHAR_DESCR class_name, int *qty, int *num_blocks,
                                  int *block_range, int *element_ids, int *labels)
{
    char *c_class_name;

    c_class_name = CHAR_CONV_F2C(class_name);

    return mc_load_conn_labels(*fam_id, *mesh_id, c_class_name, *qty, num_blocks, &block_range, element_ids, labels);
}

Return_value mc_def_conn_surface_(Famid *fam_id, int *mesh_id, CHAR_DESCR short_name, int *qty_of_facets, int *data,
                                  int *surface_id)
{
    char *c_short_name;
    ...
    return mc_def_conn_surface(*fam_id, *mesh_id, c_short_name, *qty_of_facets, data, surface_id);
}

Return_value mc_load_nodes_(Famid *fam_id, int *mesh_id, CHAR_DESCR class_name, void *coords)
{
    char *c_class_name;
...
Return_value mc_load_node_labels_(Famid *fam_id, int *mesh_id, CHAR_DESCR class_name, int *num_blocks, int *block_range,
                                  int *labels)
{
    char *c_class_name;
    Return_value rval;
    ...
    rval = mc_load_node_labels(*fam_id, *mesh_id, c_class_name, num_blocks, &c_block_range, labels);
...
Return_value mc_get_node_label_info_(Famid *fam_id, int *mesh_id, CHAR_DESCR class_name, int *num_blocks,
                                     int *num_labels)
{
    char *c_class_name;
    Return_value rval;
    ...
    rval = mc_get_node_label_info(*fam_id, *mesh_id, c_class_name, num_blocks, num_labels);
    return rval;
}

Return_value mc_load_conns_(Famid *fam_id, int *mesh_id, CHAR_DESCR class_name, int *conns, int *mats, int *parts)
{
    char *c_class_name;
    Return_value rval;
    c_class_name = CHAR_CONV_F2C(class_name);

    rval = mc_load_conns(*fam_id, *mesh_id, c_class_name, conns, mats, parts);
    return rval;
}

Return_value mc_load_surface_(Famid *fam_id, int *mesh_id, int surf, CHAR_DESCR class_name, int *conns)
{
    char *c_class_name;
...
Return_value mc_get_mesh_id_(Famid *fam_id, CHAR_DESCR mesh_name, int *p_mesh_id)
{
    char *c_mesh_name;
...
Return_value mc_def_svars_(Famid *fam_id, int *qty_svars, CHAR_DESCR names, int *name_stride, CHAR_DESCR titles,
                           int *title_stride, int types[])
{
    ...
    return mc_def_svars(*fam_id, *qty_svars, c_names, *name_stride, c_titles, *title_stride, types);
}

Return_value mc_def_vec_svar_(Famid *fam_id, int *type, int *qty_fields, CHAR_DESCR name, CHAR_DESCR title,
                              CHAR_DESCR field_names, int *name_stride, CHAR_DESCR field_titles, int *title_stride)
{
    ...
    for ( i = 0; i < qty; i++ )
    {
        str_dup_f2c(&field_names_array[i], c_field_names + i * n_stride, n_stride);
        str_dup_f2c(&field_titles_array[i], c_field_titles + i * t_stride, t_stride);
    ...
    if ( rval == OK )
    {
        rval = mc_def_vec_svar(*fam_id, dtype, qty, c_name, c_title, field_names_array, field_titles_array);
    }
...
Return_value mc_def_arr_svar_(Famid *fam_id, int *rank, int dims[], CHAR_DESCR name, CHAR_DESCR title, int *type)
{
    char *c_name, *c_title;
...
Return_value mc_def_vec_arr_svar_(Famid *fam_id, int *rank, int dims[], CHAR_DESCR name, CHAR_DESCR title,
                                  int *qty_fields, CHAR_DESCR field_names, int *name_stride, CHAR_DESCR field_titles,
                                  int *title_stride, int *type)
{
    ...
    if ( rval == OK )
    {
        rval = mc_def_vec_arr_svar(*fam_id, *rank, dims, c_name, c_title, qty, field_names_array, field_titles_array,
                                   *type);
    }
...
Return_value mc_open_srec_(Famid *fam_id, int *mesh_id, int *p_srec_id)
{
    return mc_open_srec(*fam_id, *mesh_id, p_srec_id);
}

int mc_close_srec_(Famid *fam_id, int *p_srec_id)
{
    return mc_close_srec(*fam_id, *p_srec_id);
}

Return_value mc_def_subrec_(Famid *fam_id, int *srec_id, CHAR_DESCR subrec_name, int *data_org, int *qty_svars,
                            CHAR_DESCR svar_names, int *name_stride, CHAR_DESCR subclass, int *format, int *qty,
                            int *mo_ids, int *flag)
{
    Return_value rval;
    ...
    rval = mc_def_subrec(*fam_id, *srec_id, c_subrec_name, *data_org, *qty_svars, c_svar_names, *name_stride,
                         c_subclass, *format, *qty, mo_ids, flag);

    return rval;
}

Return_value mc_flush_(Famid *fam_id, int *data_type)
{
    return mc_flush(*fam_id, *data_type);
}

Return_value mc_new_state_(Famid *fam_id, int *srec_id, float *time, int *p_file_suffix, int *p_file_state_index)
{
    return mc_new_state(*fam_id, *srec_id, *time, p_file_suffix, p_file_state_index);
}

Return_value mc_restart_at_state_(Famid *fam_id, int *p_file_suffix, int *p_state_index)
{
    return mc_restart_at_state(*fam_id, *p_file_suffix, *p_state_index);
}

Return_value mc_restart_at_file_(Famid *fam_id, int *file_name_index)
{
    return mc_restart_at_file(*fam_id, *file_name_index);
}

Return_value mc_wrt_stream_(Famid *fam_id, int *type, int *qty, void *data)
{
    return mc_wrt_stream(*fam_id, *type, *qty, data);
}

Return_value mc_wrt_subrec_(Famid *fam_id, CHAR_DESCR subrec_name, int *p_start, int *p_stop, void *data)
{
    char *c_subrec_name;
...
Return_value mc_rewrite_subrec_(Famid *fam_id, CHAR_DESCR subrec_name, int *p_start, int *p_stop, void *data,
                                int *st_index)
{
    char *c_subrec_name;
...
Return_value mc_read_results_(Famid *fam_id, int *p_state, int *p_subrec_id, int *p_qty, CHAR_DESCR res_names,
                              int *name_stride, void *p_data)
{
    char *c_res_names;
    char **specs, **c_specs;
    char *spec_buf, *p_c;
    ...
    rval = mc_read_results(*fam_id, *p_state, *p_subrec_id, qty, c_specs, p_data);
...
Return_value mc_get_svar_size_(Famid *p_fam_id, CHAR_DESCR class_name, CHAR_DESCR var_name, int *p_num_blocks,
                               int *p_size, int *p_type)
{
    Return_value rval;
    ...
    rval = mc_get_svar_size(*p_fam_id, c_class_name, c_var_name, p_num_blocks, p_size, p_type);

    return rval;
}

Return_value mc_get_svar_mo_ids_on_class_(Famid *p_fam_id, CHAR_DESCR class_name, CHAR_DESCR var_name, int *blocks)
{
    Return_value rval;
    char *c_class_name, *c_var_name;
    ...
    rval = mc_get_svar_mo_ids_on_class(*p_fam_id, c_class_name, c_var_name, blocks);

    return rval;
}

Return_value mc_get_svar_on_class_(Famid *p_fam_id, int *p_state, CHAR_DESCR class_name, CHAR_DESCR var_name,
                                   void *result)
{
    Return_value rval;
    char *c_class_name, *c_var_name;
    ...
    rval = mc_get_svar_on_class(*p_fam_id, *p_state, c_class_name, c_var_name, result);

    return rval;
}

Return_value mc_limit_states_(Famid *fam_id, int *states_per_file)
{
    return mc_limit_states(*fam_id, *states_per_file);
}

Return_value mc_limit_filesize_(Famid *fam_id, int *filesize)
{
    return mc_limit_filesize(*fam_id, *filesize);
}

Return_value mc_suffix_width_(Famid *fam_id, int *suffix_width)
{
    return mc_suffix_width(*fam_id, *suffix_width);
}

void mc_print_error_(CHAR_DESCR preamble, int *return_value)
{
    char *c_preamble;
...
Return_value mc_query_family_(Famid *fam_id, int *req_type, void *num_args, CHAR_DESCR char_args, int *p_info)
{
    Return_value rval;
    char *c_char_args;
    void *p_void;
...
Return_value mc_get_class_info_(Famid *famid, int *mesh_id, int *superclass, int *class_index, CHAR_DESCR short_name,
                                CHAR_DESCR long_name, int *object_qty)
{
    ...
    rval = mc_get_class_info(*famid, *mesh_id, *superclass, *class_index, p_short_name, p_long_name, object_qty);
...
Return_value mc_get_simple_class_info_(Famid *famid, int *mesh_id, int *superclass, int *class_index,
                                       CHAR_DESCR short_name, CHAR_DESCR long_name, int *start_ident, int *stop_ident)
{
    static char c_short_name[M_MAX_NAME_LEN + 1];
    static char c_long_name[M_MAX_NAME_LEN + 1];
    Return_value rval;
    ...
    rval = mc_get_simple_class_info(*famid, *mesh_id, *superclass, *class_index, p_short_name, p_long_name, start_ident,
                                    stop_ident);
...
Return_value mc_set_buffer_qty_(Famid *famid, int *mesh_id, CHAR_DESCR class_name, int *buf_qty)
{
    char *c_class_name;
 ...
 *
 ************************************************************************/
Return_value mc_ti_undef_class_(Famid *famid)
{
    return mc_ti_undef_class(*famid);
}

Return_value mc_ti_def_class_(Famid *famid, int *meshid, int *state, int *matid, CHAR_DESCR superclass, int *meshvar,
                              int *nodal, CHAR_DESCR short_name, CHAR_DESCR long_name)
{
    ...
    return mc_ti_set_class(*famid, *meshid, *state, *matid, c_superclass, meshvar_flag, nodal_flag, c_short_name,
                           c_long_name);
}

Return_value mc_ti_set_class_(Famid *famid, int *meshid, int *state, int *matid, CHAR_DESCR superclass, int *meshvar,
                              int *nodal, CHAR_DESCR short_name, CHAR_DESCR long_name)
{
    char *c_superclass, *c_short_name, *c_long_name;
...
void mc_ti_enable_(Famid famid)
{
    mc_ti_enable(famid);
}

void mc_ti_disable_(Famid famid)
{
    mc_ti_disable(famid);
}

Return_value mc_ti_make_var_name_(Famid *famid, CHAR_DESCR name, CHAR_DESCR class, CHAR_DESCR new_name)
{
    char *c_class;
    char *c_name;
    char *p_name;
...
Return_value mc_ti_wrt_scalar_(Famid *fam_id, int *type, CHAR_DESCR name, void *value)
{
    char *c_name;
...
Return_value mc_ti_read_scalar_(Famid *famid, CHAR_DESCR name, void *value)
{
    char *c_name;
    Return_value rval;
...
Return_value mc_ti_wrt_string_(Famid *fam_id, CHAR_DESCR name, CHAR_DESCR value)
{
    char *c_name, *c_value;
...
Return_value mc_ti_read_string_(Famid *famid, CHAR_DESCR name, CHAR_DESCR value)
{
    char *c_name;
    char *p_value;
    static char c_value[M_MAX_STRING_LEN + 1];
...
Return_value mc_ti_wrt_array_(Famid *famid, int *type, CHAR_DESCR name, int *order, int *dims, void *data)
{
    char *c_name;
...
Return_value mc_ti_read_array_(Famid *famid, CHAR_DESCR name, void *value, int *num_items_read)
{
    char *c_name;
...
Return_value mc_ti_get_metadata_(Famid *fam_id, CHAR_DESCR mili_version, CHAR_DESCR host, CHAR_DESCR arch,
                                 CHAR_DESCR timestamp, CHAR_DESCR username, CHAR_DESCR xmilics_version,
                                 CHAR_DESCR code_name)
{
    char *c_mili_version, *c_host, *c_arch, *c_timestamp, *c_username, *c_xmilics_version, *c_code_name;
    ...
    return mc_ti_get_metadata(*fam_id, c_mili_version, c_host, c_arch, c_timestamp, c_username, c_xmilics_version,
                              c_code_name);
}

Return_value mc_get_metadata_(Famid *fam_id, CHAR_DESCR mili_version, CHAR_DESCR host, CHAR_DESCR arch,
                              CHAR_DESCR timestamp, CHAR_DESCR xmilics_version)
{
    ...
    return mc_get_metadata(*fam_id, c_mili_version, c_host, c_arch, c_timestamp, c_xmilics_version);
}

Return_value mc_ti_check_arch_(Famid fam_id)
{
