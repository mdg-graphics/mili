...
int read_partition_mili(char *partition_file_name, Partition_mili **map);

int read_partition_ti_global(Famid fam_id, int proc, Bool_type alloc_mem, Partition_mili **map);

int read_partition_ti_local(Famid fam_id, int proc, Bool_type alloc_mem, Partition_mili **map);

int calc_global_element_number(Partition_mili *c_map, int obj_type, int local_index, int proc);
