 ...
 * eprtf.h - Header file for extended printf functions.
 *
...
Return_value eprintf(int *num_written, char *, ...);

Return_value efprintf(FILE *, char *, ...);

Return_value esprintf(char *, char *, ...);
